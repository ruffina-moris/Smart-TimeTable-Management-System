...
<div class="navbar navbar-inverse navbar-fixed-top " id="menu">
    <div class="container">
        <div align="center">
            <h3 align="center">TIME TABLE MANAGEMENT SYSTEM - Loyola-ICAM College of Engineering and Technology</h3>
        </div>
    </div>
</div>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <img src="assets/img/licet.jpg" alt="Chania">
        </div>

        <div class="item">
            <img src="assets/img/licet2.jpg" alt="Chania">
        </div>
        ...
        <div class="item">
            <img src="assets/img/lab.1.jpg" alt="Flower">
        </div>
    </div>
</div>
...
<div align="center" STYLE="margin-top: 30px">
    <button data-scroll-reveal="enter from the bottom after 0.2s"
            id="teacherLoginBtn" class="btn btn-info btn-lg">STUDENT LOGIN
    </button>
    <button data-scroll-reveal="enter from the bottom after 0.2s"
            id="adminLoginBtn" class="btn btn-success btn-lg">TEACHER LOGIN
    </button>
</div>
<br>
<div align="center">
    ...
    <div class="modal-content">
        ...
        <div style="display:none" id="facultyForm">
            <form action="facultyformvalidation.php" method="POST" style="overflow: hidden">
                <div class="form-group">
                    <label for="facultyno">Student No.</label>
                    <input type="text" class="form-control" id="facultyno" name="FN" placeholder="Student No. ...">
                </div>
                <div align="right">
        ...
        <div class="row">
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.4s">
                <div class="faculty-div">
                    ...
                    <h3 align="center">Prof. JULIANA</h3>
                    <hr/>
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.5s">
                <div class="faculty-div">
                    <img src="assets/img/faculty/ap.jpg" class="img-rounded"/>
                    <h3 align="center">PROF. KAVITHA VIJAYAN</h3>
                    <hr/>
                    <h4 align="center">ASSISTANT PROFESSOR<br/> IT DEPARTMENT</h4>

                </div>
            </div>
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.6s">
                <div class="faculty-div">
                    <img src="assets/img/faculty/pc.jpg" class="img-rounded"/>
                    <h3 align="center">PROF. SHOBANA</h3>
                    <hr/>
                    <h4 align="center">INTERNSHIP CO-ORDINATOR<br/>IT DEPARTMENT</h4>
...
<div class="container">
    <div class="row set-row-pad">
        <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1 "
            ...
            <hr/>
            <div>
                <h4>LOYOLA-ICAM COLLEGE OF ENGINEERING AND TECHNOLOGY
                </h4>
                <h4>NUNGAMBAKKAM, CHENNAI-64</h4>
                <h4><strong>Call:</strong> 91-44-28178490 </h4>
                <h4><strong>Email: </strong>licet@licet.ac.in</h4>
            </div>
